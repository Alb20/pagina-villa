        ...
        <div className="container px-4 text-center">
                ...
                <div className="col-8">
                    ...
                    <ul>
                            ...
                            <li>Batucada</li>
                            <li>Decorador (Costo extra)</li>
                            <li>Pista Iluminada (Costo extra)</li>                           
                          </ul>
                          <p>El costo del decorador como el de la pista iluminda se explica en la cita*</p>
                    </div>
                </div>
                <div className="col-4">
                    <div className="p-3 border bg-light">
