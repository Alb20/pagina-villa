...
import CarouselS2 from './Carusel/CarouselS2'
                ...
                <div className='container imgsespS1'>
                    <div className='row'>
                        <div className='col' id='imgs'>
                            <img src="/images/images/S2.2.png"  className='float-none rounded float-start'  alt="" />
                        </div>
                        <div className='col' id='imgs'>
                            <img src="/images/images/S2.1.png"  className='float-none rounded float-start'  alt="" />
                        </div>
